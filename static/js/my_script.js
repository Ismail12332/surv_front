...
function showCreateSubsectionModal(sectionName) {
    ...
    // Сохраните имя родительского раздела для использования при создании подраздела
    document.getElementById("subsectionParentSection").value = sectionName;
}
...
function showCreateCellModal(sectionName, subsectionName) {
    ...
    // Сохраните имя родительского раздела и подраздела для использования при создании ячейки
    document.getElementById("cellParentSection").value = sectionName;
    document.getElementById("cellParentSubsection").value = subsectionName;
}
